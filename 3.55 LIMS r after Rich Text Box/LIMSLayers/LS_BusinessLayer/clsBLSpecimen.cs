...
{
	/// <summary>
	/// Summary description for clsBLSpecimen.
	/// </summary>
	public class clsBLSpecimen
	{
		public clsBLSpecimen()
		{
			//
		...
		*/
		public DataView GetAll(int flag)
		{
			...
			{
				case 1:
					objdbhims.Query = "Select SpecimenType from LS_TSpecimenType";
					break;

				case 2:
					objdbhims.Query = "Select SpecimenContainer from LS_TSpecimenContainer";
					break;
			}
