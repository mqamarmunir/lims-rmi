       ...
       // private string StrFormula = Default;
        ...
        public bool insert()
        {
            try
            {
                ...
                objdbhims.Query = objQB.QBGetMax("DETAILDERIVEID", TableName, "6");
        ...
        private string[,] MakeArray()
        {
            ...
            if (!StrEnteredBy.Equals(Default))
            {
                ...
                AryDerivedAttribute[6, 2] = "string";
            }
            ...
            if (!StrTestID.Equals(Default))
            {
                ...
                AryDerivedAttribute[9, 2] = "string";
            }
