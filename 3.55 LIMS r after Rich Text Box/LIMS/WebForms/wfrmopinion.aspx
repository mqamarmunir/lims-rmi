<%@ Page language="c#" Inherits="HMIS.LIMS.WebForms.wfrmOpinion" CodeFile="wfrmOpinion.aspx.cs" %>
<%@ Register assembly="CKEditor.NET" namespace="CKEditor.NET" tagprefix="CKEditor" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LIMS: Test Opinion:    <% =Session["UNUIDFORMATTED"] %></title>
	...
	<body>
		<FORM id="Form1" method="post" runat="server">
			<TABLE class="label" id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
				...
				<TR>
					<TD align="center" colSpan="7"><font size="4"><STRONG>OPINION</STRONG></font></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="6"><asp:datagrid id="DGOpinion" runat="server" Width="100%" AutoGenerateColumns="False" BorderColor="Silver">
							...
							<Columns>
								...
								<asp:TemplateColumn Visible="False" HeaderText="OpinionID">
									<HeaderStyle Width="80%"></HeaderStyle>
									<ItemTemplate>
										<asp:Label id=LblVaultID runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "OpinionID")  %>'>
										</asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Opinion">
									<ItemTemplate>
										<asp:Label id=LblDescription runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Opinion")  %>'>
										</asp:Label>
                        ...
                        Toolbar="Basic" ResizeMinHeight="50" ResizeMinWidth="50" 
                            ...
                            ToolbarBasic="Source|-|Bold|Italic" MaxLength="1000"></CKEditor:CKEditorControl>--%>
										<asp:TextBox ID="TxtDescription" runat="server" Height="70px" Width="100%" TextMode="MultiLine"  Text='<%# DataBinder.Eval(Container.DataItem, "Opinion")  %>'>
										</asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
