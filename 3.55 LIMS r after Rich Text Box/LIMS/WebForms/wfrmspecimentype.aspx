<%@ Page language="c#" Inherits="HMIS.LIMS.WebForms.wfrmSpecimenType" CodeFile="wfrmSpecimenType.aspx.cs" %>
<HTML>
	<HEAD>
		<title>Specimen Type:    <% =Session["UNUIDFORMATTED"] %></title>
	...
	<body>
		<FORM id="Form1" method="post" runat="server">
			<TABLE class="label" id="Table1" style="Z-INDEX: 101; LEFT: 1px; POSITION: absolute; TOP: 1px"
				...
				<TR>
					<TD align="center" colSpan="7"><font size="4"><STRONG>SPECIMEN TYPE</STRONG></font></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD align="center" colSpan="7"><asp:datagrid id="dgSelectionValue" runat="server" CssClass="datagrid" BorderColor="Silver" AutoGenerateColumns="False"
							...
							<Columns>
								<asp:BoundColumn DataField="specimentype" SortExpression="TestGroup" ReadOnly="True" HeaderText="Selection Value">
