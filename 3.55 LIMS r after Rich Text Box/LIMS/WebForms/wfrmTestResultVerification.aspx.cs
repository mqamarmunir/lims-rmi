...
{
    /// <summary>
    /// Summary description for wfrmTestResultVerification.
    /// </summary>
    public partial class wfrmTestResultVerification : System.Web.UI.Page
    {
        private static string DGSort = "LabID ASC";
        private static string ProcessID = "0005";
        ...
        private void FillDG()
        {
            ...
            if (!this.ddlSection.SelectedItem.Value.Equals("-1"))
            {
                ...
                if (TabContainer1.ActiveTab.ID == "tbExternaltest")
                {
                    ...
                    {
                        lblExtTcount.Text = "(" + dvTGeneralTestResult.Count.ToString() + ")";
                        this.dgGroupListExt.Visible = false;
        ...
        protected void dgGroupList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Select"))
            {
                if (e.Item.Cells[11].Text.Equals("G"))
                {
                    ...
                    Response.Write("<script language = 'javascript'>window.open('wfrmTestGE.aspx?id=" + e.Item.Cells[9].Text + "&ProcessID=" + e.Item.Cells[8].Text + "&MSerialNos=" + sMSerialNos + "&SectionID=" + ddlSection.SelectedValue + "&Psex=" + e.Item.Cells[3].Text + "&PAge=" + e.Item.Cells[13].Text + "&testid=" + e.Item.Cells[12].Text + "&Tag=" + "VS" + "','','channelmode,scrollbars')</script>");
                }
                else if (e.Item.Cells[11].Text.Equals("M"))
                {
                    ...
                    Response.Write("<script language = 'javascript'>window.open('wfrmTestMicro.aspx?id=" + e.Item.Cells[10].Text + "&ProcessID=" + e.Item.Cells[8].Text + "&DSerialNos=" + sDSerialNos + "&SectionID=" + ddlSection.SelectedValue + "&Psex=" + e.Item.Cells[3].Text + "&PAge=" + e.Item.Cells[4].Text + "&testid=" + e.Item.Cells[12].Text + "&Tag=" + "VS" + "','','channelmode,scrollbars')</script>");
                }
                else if (e.Item.Cells[11].Text.Equals("H"))
                {
                    ...
                    Response.Write("<script language = 'javascript'>window.open('wfrmTestHisto.aspx?id=" + e.Item.Cells[9].Text + "&ProcessID=" + e.Item.Cells[8].Text + "&MSerialNos=" + sMSerialNos + "&SectionID=" + ddlSection.SelectedValue + "&Psex=" + e.Item.Cells[3].Text + "&PAge=" + e.Item.Cells[4].Text + "&testid=" + e.Item.Cells[12].Text + "&Tag=" + "VS" + "','','channelmode,scrollbars')</script>");
                }
            }
        }
        ...
        protected void dgGrouplist_OnRowDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                dv_chkRepeat.Dispose();
                obj_chkRepeat=null;
                #region "Getting Peer Reviews"
                ////////////////////////////-------Getting Peer Reviews-------//////////////////////
                clsBlPeerReviews obj_Reviews = new clsBlPeerReviews();
                obj_Reviews.DSerialNo = e.Item.Cells[10].Text.Trim();
                DataView dv_peerComments = obj_Reviews.GetAll(3);
                if (dv_peerComments.Count > 0)
                {
                    ((Panel)e.Item.Cells[16].FindControl("pnlComments")).Visible = true;
                    ((ImageButton)e.Item.Cells[16].FindControl("gvimgReviewComments")).Visible = true;
                    ((GridView)e.Item.Cells[16].FindControl("gvComments")).DataSource = dv_peerComments;
                    ((GridView)e.Item.Cells[16].FindControl("gvComments")).DataBind();
                }
