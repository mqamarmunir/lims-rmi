<%@ Page language="c#" Inherits="HMIS.LIMS.WebForms.WebForm1" CodeFile="wfrmTestGroup.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LIMS:Test Group Registration:    <% =Session["UNUIDFORMATTED"] %></title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" class="label">
				...
				<TR>
					<TD align="center" colSpan="6"><font size="4"><STRONG>TEST GROUP REGISTRATION</STRONG></font></TD>
				</TR>
				<TR>
					<TD align="right" colSpan="6">
						...
						<asp:ImageButton id="ibtnTest" runat="server" ImageUrl="images/btn_Test.gif"></asp:ImageButton>
				...
				<TR>
					...
					<TD colspan="2"><asp:DropDownList id="ddlSection" runat="server" Width="100%" AutoPostBack="True" tabIndex="1" onselectedindexchanged="ddlSection_SelectedIndexChanged"></asp:DropDownList></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD width="35%">
						<asp:TextBox id="txtGroup" runat="server" Width="100%" CssClass="mandatoryfield" tabIndex="3"
				...
				<TR>
					<TD colSpan="6" align="center">
						<asp:DataGrid id="dgGroupList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="TestGroup" SortExpression="TestGroup" ReadOnly="True" HeaderText="Group">
